...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {
	//modified nlhs so the number of output arguments looked for is 1 instead of 2
    ...
    //This parses the input for the escape, quote and sep variables, but I have hardcoded them here.
    char quote = '"';
    char sep = ',';
    char escape = '\\';
